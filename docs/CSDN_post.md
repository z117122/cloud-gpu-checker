...
![GUI 界面](https://raw.githubusercontent.com/z117122/cloud-gpu-checker/main/assets/screenshots/gui-overview.png)

### 状态结果

结果面板里会重点展示当前任务、当前模型、已完成部分，以及当前子实验和整批实验的大致剩余时间。

![状态结果](https://raw.githubusercontent.com/z117122/cloud-gpu-checker/main/assets/screenshots/status-report.png)
